...
// IPC registration module plus the updater module. Fork-specific handlers
// (council, worktree, multi-profile sessions, kanban-govern, anthropic-oauth)
// register at module load from main/index.ts.
const indexSrc = [
  "src/main/index.ts",
